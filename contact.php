...
<head>
    ...
    <title>Program Sales Thai Mtrology Group</title>
...
<!-- Section Page-title -->
    <header class="jarallax" data-speed="0.5" style="background-image: url(assets/images/bg2.jpg);">
        <div class="page-image">
            <h1 class="display-4 font-weight-bold">ข้อมูลการติดต่อ</h1>
            <p class="lead">Sales Thai Metrology Group</p>
        </div>
    </header>
    ...
    <section class="container py-5">
            ...
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">179/88 ถ. นาวงประชาพัฒนา แขวงสีกัน เขตดอนเมือง กรุงเทพมหานคร 10210</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p  class="card-text">(+66)02116-2438</p>
                        <h4 class="card-title">Fax:</h4>
                        <p  class="card-text">(+66)02116-2439</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p  class="card-text">info@thaimetrology.com</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"> แบบฟอร์มติดต่อเราโดยตรง </h5>
                        <form method="post" action="php/contact.php">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="department" id="department" name="department" class="form-control" required placeholder="แผนก">
                                </div>
                            ...
                            <div id="recaptcha-wrapper" class="text-center my-2">
                                <div class="g-recaptcha d-inline-block" data-callback="recaptchaCallback" data-sitekey="6LdWp60UAAAAAJmlePHHyr3vqpUTvFvsrlKDo0A4"></div>
                            </div>
